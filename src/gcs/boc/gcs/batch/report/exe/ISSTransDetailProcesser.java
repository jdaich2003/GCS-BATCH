 ...
 * 
 */
public class ISSTransDetailProcesser {
	...
	private static Logger logger = Logger
			.getLogger(ISSTransDetailProcesser.class);

	public ISSTransDetailProcesser(Map<String, String> conditions)
	...
	public void process() throws GCSReportException {
		...
		try {
			...
			// params.setDate(conditions.get("date"));
